module github.com/zkayyali812/openshift-pipelines/kcp-ns-cleanup

go 1.18

require (
	github.com/stolostron/hypershift-deployment-controller v0.0.0-20220615151411-da5bd773c25a
...
require (
	...
	github.com/openshift/hypershift v0.0.0-20220607131543-f684373220da // indirect
